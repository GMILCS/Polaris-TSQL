It work for me.  Here is the Query in a more compact format with the date range changed and formatted differently.  Try pasting this into the MS SQL Server Management Studio query window.  Make sure you have selected the "Polaris" database.
